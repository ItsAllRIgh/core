...
public class RestfulBook {
    ...
    public BookArmor armorById(@PathVariable(name = "id", required = true) long id, Model model) {
        BookArmor book_armor = null;
    ...
    public List<BookWeapons> weapons() {
    ...
    public BookWeapons weaponById(@PathVariable(name = "id", required = true) long id, Model model) {
        BookWeapons book_armor = null;
