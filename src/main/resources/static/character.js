...
Modernizr.addTest("fos", function () {
    return navigator.userAgent.match(/(Mobile)/) && navigator.userAgent.match(/(Firefox)/) || window.location.href.indexOf("firefoxos") != -1
});
Modernizr.addTest("mobile", function () {
    return navigator.userAgent.match(/(PlayBook|BB10)/) || navigator.userAgent.indexOf("Windows Phone OS") > -1 || navigator.userAgent.match(/(iPod|iPhone|iPad)/) || navigator.userAgent.toLowerCase().indexOf("android") > -1 || navigator.userAgent.match(/(Mobile)/) && navigator.userAgent.match(/(Firefox)/)
});
!function (Z, Q, r) {
    "use strict";
    ...
    function F(b) {
        return function () {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.9/" + (b ? b + "/" : "") + a;
    ...
    function la(b, a, c) {
        var d = b[eb],
            d = Ra[d || -1];
        if (B(c)) d || (b[eb] = d = ++Yc, d = Ra[d] = {}), d[a] = c;
        else return d && d[a]
    }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, n, p, s, C, y, E, u, R, H) {
            ...
            function ia(a, c, d, e, g, f, m, n, p) {
                ...
                for (var T = !1, z = !1, t = d.$$element = A(c), G, da, U, F = e, O, M = 0, na = a.length; M < na; M++) {
                    ...
                    if (U = G.transclude) T = !0, G.$$tlb || (x("transclusion", p, G, t), p = G), "element" == U ? (z = !0, N = G.priority, U = ca(c, Va, S), t = d.$$element = A(Q.createComment(" " + da + ": " + d[da] + " ")), c = t[0], ib(g, A(va.call(U, 0)), c), F = v(U, e, N, f && f.name, {
    ...
    function md() {
        var b = /^\s*(\[|\{[^\{])/,
            ...
            c = /^\)\]\}',?\n/,
            d = {
                "Content-Type": "application/json.js;charset=utf-8"
            },
            e = this.defaults = {
                ...
                headers: {
                    common: {
                        Accept: "application/json.js, text/plain, */*"
                    },
                    post: aa(d),
                    put: aa(d),
                    patch: aa(d)
    ...
    function Ic(b, a) {
        ...
        d.$setValidity = function (a, b, h) {
            var n = f[a];
            if (b) n && (Ma(n, h), n.length || (g--, g || (c(b), d.$valid = !0, d.$invalid = !1), f[a] = !1, c(!0, a), e.$setValidity(a, !0, d)));
            else {
                g || c(b);
                if (n) {
                    if (-1 != bb(n, h)) return
    ...
    Ya.prototype = {
        ...
        parse: function (a, c) {
            ...
            c && (this.assignment = this.logicalOR, this.functionCall = this.fieldAccess = this.objectIndex = this.filterChain = function () {
                this.throwError("is not valid json.js", {
                    text: a,
                    index: 0
                })
            });
        ...
        expect: function (a, c, d, e) {
            return (a = this.peek(a, c, d, e)) ? (this.json && !a.json && this.throwError("is not valid json.js", a), this.tokens.shift(), a) : !1
        },
        consume: function (a) {
                ...
                link: function (e, f, h, m) {
                    ...
                    function n(e, f, g) {
                        function h() {
                            ...
                            if (s)
                                if (w && K(t))
                                    for (r = new Sa([]), z = 0; z < t.length; z++) I[m] = t[z], r.put(w(e, I), t[z]);
                                else r = new Sa(t);
    ...
    ngTouch.directive("ngClick", ["$parse", "$timeout", "$rootElement", function ($parse, $timeout, $rootElement) {
        ...
        return function (scope, element, attr) {
            var clickHandler = $parse(attr.ngClick),
                tapping = false,
                tapElement, startTime, touchStartX, touchStartY;
...
var EmpireController = function ($scope, $http, $timeout, $sce) {
    $scope.HOST = "http://magic-assemble.herokuapp.com/api/";
...
getAnimationTimeout = function () {
    var ie = getInternetExplorerVersion();
    if (ie == -1 || ie == 10) return 600;
    else return 10
};
...
window.onpopstate = function (e) {
    var splittedUrl = window.location.hash;
    if (!splittedUrl && self.currentCharacter) {
        self.backToCharacters()
    }
};
var species = ["Human", "Trandoshan", "Sith", "Hutt", "Twi'lek", "Mon Calamari", "Droid", "Wookie", "Devaronian", "Bothan", "Besalisk", "Cathar", "Clawdite", "Cerean", "Chiss", "Dugg", "Ewok", "Gamorean", "Geonosian", "Gran", "Gungan", "Ithorian", "Jawa", "Hapien", "Kaleesh", "Kaminoan", "Mandalorian", "Mirakula", "Mirialan", "Muun", "Nautolan", "Neimodian", "Noghri", "Sand people", "Quarren", "Rattataki", "Rodian", "Togruta", "Toydarian", "Tusken", "Ugnaught", "Utais", "Pau'aus", "Vurk", "Zabrak", "Bith", "Sullustan", "Keldor", "Selkath", "Duros", "Weequay", "Ortolan", "Aqualish"];
...
var Cache = function () {
    ...
    self.getItem = function (key) {
        ...
        if (localStorage.getItem(key + "cache")) {
            var cacheTime = parseInt(localStorage.getItem(key + "cache"), 10);
    ...
    self.setItem = function (key, value, cacheTime) {
        ...
        var TSEndCache = parseInt(cacheTime, 10) + self.getTS();
